...
| `https://github.com/yinyucheng0601/pto-design-system` | `candidate-active` / `mirror-candidate` | `design-system-source` | Batch D 决定同步方式和 `07-designsystem/` 投影。 |
...
- `yinyucheng0601/pto-design-system` 的同步方式和 `07-designsystem/` 投影边界。
