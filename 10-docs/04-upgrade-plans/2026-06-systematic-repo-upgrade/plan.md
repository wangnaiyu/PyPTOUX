...
- 新建 `10-docs/04-upgrade-plans/2026-06-systematic-repo-upgrade/`
- 写入 README、计划、状态、决策、开放问题、source 刷新清单和续作 prompts
- 轻量更新 `10-docs/01-conventions/` 与 `10-docs/03-indexes/content-map.md`
...
目标：建立 PTO design system 的上游同步与本仓库投影方式。
...
- 更新 `AGENTS.md`
- 更新相关 `.agents/skills/*`
- 更新 `10-docs/01-conventions/*`
- 更新 `10-docs/03-indexes/*`
- 写 `final-report.md`
